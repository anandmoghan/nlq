...
class AggregatePredictor:
    def __init__(self, args, token_weights):
        ...
        embedding = tf.get_variable("aggregate_embedding", [total_unique_tokens, args.emb_size], initializer=tf.constant_initializer(token_weights))
        ...
        dense_layer_w = tf.get_variable("aggregate_dense_layer_w", [const.AGG_RNN_SIZE, const.AGG_COUNT])
        dense_layer_b = tf.get_variable("aggregate_dense_layer_b", [const.AGG_COUNT])
...
class SelectPredictor:
    def __init__(self, args, token_weights):
        ...
        embedding = tf.get_variable("select_embedding", [total_unique_tokens, args.emb_size], initializer=tf.constant_initializer(token_weights))
        ...
        dense_layer_w = tf.get_variable("select_dense_layer_w", [const.SEL_RNN_SIZE, const.SEL_COUNT])
        dense_layer_b = tf.get_variable("select_dense_layer_b", [const.SEL_COUNT])
